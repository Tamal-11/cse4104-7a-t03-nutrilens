...
export const endpointDocs: EndpointDoc[] = [
  ...
  },
  {
    ...
    responses: {
      ...
      "400": { success: false, message: "Image file is required or unsupported image type/size." },
      "401": { success: false, message: "Authentication required." },
    },
  },
  {
    ...
    responses: {
      "200": { success: true, message: "Analysis completed.", data: { foodName: "Pizza", confidence: 0.87, nutrition: "100 g estimate", classification: "Moderate" } },
